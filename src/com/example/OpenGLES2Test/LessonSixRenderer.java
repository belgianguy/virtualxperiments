...
// view matrix. In OpenGL 2, we can keep track of these matrices separately if we choose.
        ...
        // Load the texture
        mBrickDataHandle = TextureHelper.loadTexture(mActivityContext, R.drawable.stones);
        GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);

        mGrassDataHandle = TextureHelper.loadTexture(mActivityContext, R.drawable.chalk);
        GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);

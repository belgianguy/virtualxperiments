...
// R, G, B, A
    ...
    //Fix: ambient light which was depending on the distance :
    protected String getBetterVertexShader()
    {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config)
    {
        ...
        final String vertexShader = getBetterVertexShader();//getVertexShader();
